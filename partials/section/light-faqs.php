  ...
  <div class="b-container">
    <div class="row row-cols-1 row-cols-lg-2 py-5">
      <div class="col d-flex flex-column align-items-center align-items-lg-start text-center text-lg-start">
        <h6 class="text-primary-color fw-semibold mb-4">FREQUENTLY ASKED QUESTION</h6>
        <h2 class="font-1 mb-4" style="font-weight: 800;">
          The <span class="text-primary-color">Most</span> Question<br>
          <span class="text-primary-color">We Got </span> So Far
        </h2>
        ...
        <div class="bg-primary-color d-flex flex-column text-white px-4 rounded-5 w-auto">
          <div class="d-flex justify-content-between gap-5">
            ...
            <p class="font-1 fs-5 fw-bolder pt-3 p-0">4,9 /5</p>
          </div>
        </div>
        <p class="mt-4 mb-5" style="font-size: large;">Through consistent care and compassionate guidance, we help
        ...
        <div class="accordion" id="accordionFaqs" data-aos="fade-up" data-aos-easing="ease-out-cubic"
          ...
          <div class="accordion-item">
            ...
            <div id="faq-1" class="accordion-collapse collapse show" data-bs-parent="#accordionFaqs">
              <div class="accordion-body">If you experience persistent feelings of sadness, anxiety, or stress that
          ...
          <div class="accordion-item">
            ...
            <div id="faq-2" class="accordion-collapse collapse" data-bs-parent="#accordionFaqs">
              <div class="accordion-body">Mental health refers to a person’s emotional, psychological, and social
                well-being. It affects how people think, feel, and behave. Maintaining good mental health is
                essential for handling stress, building relationships, and making decisions in daily life.</div>
            </div>
          </div>
          <div class="accordion-item">
            <h2 class="accordion-header">
            ...
            <div id="faq-3" class="accordion-collapse collapse" data-bs-parent="#accordionFaqs">
              <div class="accordion-body">Yes, online therapy can be very effective for many individuals. It offers
          ...
          <div class="accordion-item">
            ...
            <div id="faq-4" class="accordion-collapse collapse" data-bs-parent="#accordionFaqs">
              <div class="accordion-body">You can improve your mental well-being by practicing self-care, such as
